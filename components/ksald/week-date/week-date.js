Component({
  ...
  methods: {
    ...
    nextWeek() {
      ...
      this.triggerEvent('nextweek', item)
    },
    prevWeek() {
      ...
      this.triggerEvent('prevweek',item )
    },
    ...
    dateClick(e) {
      ...
      //{"today":"2023-09-15","weekRange":["2023-09-11","2023-09-17"]} 
      this.triggerEvent('click', {
        today:item.date,
        weekRange:[this.data.weeksArr[0].date,this.data.weeksArr[6].date]
      })
    }
  }
})