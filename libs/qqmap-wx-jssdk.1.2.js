...
var URL_DISTANCE = BASE_URL + 'distance/v1/matrix';//https://apis.map.qq.com/ws/distance/v1/matrix
    ...
    handleData(param,data,feature){
      if (feature == 'search') {
        ...
        */
        ...
        //新版结构有变 https://lbs.qq.com/service/webService/webServiceGuide/webServiceMatrix
        //console.log(JSON.stringify(data.result));
        //{"rows":[{"elements":[{"distance":568},{"distance":589},{"distance":573},{"distance":915},{"distance":1622}]}]}
        var calculateDistanceResult = data.result.rows[0].elements;  
        //console.log(JSON.stringify(calculateDistanceResult));
        var distance = [];
        for (var i = 0; i < calculateDistanceResult.length; i++){
          distance.push(calculateDistanceResult[i].distance);
        }   
